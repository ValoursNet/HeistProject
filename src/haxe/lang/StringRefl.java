...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar152 = (f);
			int __temp_hash154 = __temp_svar152.hashCode();
			boolean __temp_executeDef153 = true;
			switch (__temp_hash154)
			{
				case -1106363674:
				{
					if (__temp_svar152.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash154 == 530542161 ) && __temp_svar152.equals("substring") )) || ( (( ( __temp_hash154 == -891529231 ) && __temp_svar152.equals("substr") )) || ( (( ( __temp_hash154 == 109648666 ) && __temp_svar152.equals("split") )) || ( (( ( __temp_hash154 == -467511597 ) && __temp_svar152.equals("lastIndexOf") )) || ( (( ( __temp_hash154 == 1943291465 ) && __temp_svar152.equals("indexOf") )) || ( (( ( __temp_hash154 == 397153782 ) && __temp_svar152.equals("charCodeAt") )) || ( (( ( __temp_hash154 == -1361633751 ) && __temp_svar152.equals("charAt") )) || ( (( ( __temp_hash154 == -1137582698 ) && __temp_svar152.equals("toLowerCase") )) || __temp_svar152.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef153 = false;
